...
_$_CnbcNewsArticleResponse _$$_CnbcNewsArticleResponseFromJson(
        Map<String, dynamic> json) =>
    _$_CnbcNewsArticleResponse(
      data: json['data'] == null
          ? null
...
Map<String, dynamic> _$$_CnbcNewsArticleResponseToJson(
        _$_CnbcNewsArticleResponse instance) =>
    <String, dynamic>{
      'data': instance.data,
